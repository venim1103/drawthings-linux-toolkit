  ...
  private func internalImport(versionCheck: @escaping (ModelVersion) -> Void) throws -> (
    ...
    try graph.withNoGrad {
      ...
      case .ltx2_3:
        ...
        // These aggregate-embed tensors are kept in bfloat16 by the official
        // Draw Things converter (datatype 0x80000). Writing them as Float16
        // (the converter's default FloatType) makes the runtime loader crash in
        // ccv_nnc_tensor_read at model load. isBF16: true preserves bfloat16.
        ...
        ltx23TextFeatureAliases["text_embedding_projection.video_aggregate_embed.bias"] =
          ModelWeightElement(["t-video_aggregate_embed-0-1"], isBF16: true)
        ltx23TextFeatureAliases["text_embedding_projection.audio_aggregate_embed.weight"] =
          ModelWeightElement(["t-audio_aggregate_embed-0-0"], isBF16: true)
        ltx23TextFeatureAliases["text_embedding_projection.audio_aggregate_embed.bias"] =
          ModelWeightElement(["t-audio_aggregate_embed-0-1"], isBF16: true)
